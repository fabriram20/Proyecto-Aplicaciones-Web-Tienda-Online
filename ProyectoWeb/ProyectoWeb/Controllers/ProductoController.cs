...
namespace ProyectoWeb.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdProducto,NombreProducto,Foto,Precio")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdProducto,NombreProducto,Foto,Precio")] Producto producto)
        {
            if (ModelState.IsValid)
            {
